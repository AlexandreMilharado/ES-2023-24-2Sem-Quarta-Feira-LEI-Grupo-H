...
describe("handleSubmit", () => {
	...
	it.runIf(TESTBACKEND)("devolve uma mensagem de erro caso o link do ficheiro for inválido", async () => {
	...
	it.runIf(TESTBACKEND)("devolve uma mensagem de erro caso o link do ficheiro não acabar em .CSV ou .JSON", async () => {
		const expectedError = { error: "Failed to fetch CSV/JSON file" };
		let event: any = getTestEventWithUrl(
	...
	it.runIf(TESTBACKEND)("devolve o .JSON com formato correto dado um link para fazer o download", async () => {
		let event: any = getTestEventWithUrl(
	...
	it.runIf(TESTBACKEND)("devolve o .CSV com formato correto dado um link para fazer o download", async () => {
		let event: any = getTestEventWithUrl(
