 ...
 */
export function getTestFileText() {
 ...
 * @returns {Array<JSON>} Array<JSON> com header personalizado dos dados do horário
 */
export function getTestFileJSON() {
  return [
    {
      "Curso": "ME",
 ...
 */
export function getTestFileTextWithoutHeaders() {
 ...
 * @returns {Array<JSON>} Array<JSON> sem header personalizado dos dados do horário
 */
export function getTestFileWithoutHeadersJSON() {
  return [
    {
        "0": "ME",
 ...
 * @returns {Event} - evento com alguns atributos preenchidos para teste
 */
export function getTestEventWithUrl(url) {
 ...
 * @returns {Event} - evento com forms vazio
 */
export function getTestEventWithEmptyValues() {
  return {preventDefault: function() {
    return;
  }, currentTarget : stringToHTMLElement(`<form id="localUpload" method="post">
                    <input name="localFile" type="file" multiple accept=".csv">
